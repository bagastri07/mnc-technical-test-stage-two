...
func BindingFromContext[T any](ctx context.Context, keys []constant.CtxKey, validator bindingCtxValidator[T]) (*T, error) {
	var (
...
func DumpIncomingContext[T any](ctx context.Context, keys []constant.CtxKey) string {
